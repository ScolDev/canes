...
describe('Tests for CPU module.', () => {
  ...
  test('should power-up the cpu', () => {
    ...
    expect(memory.getMemorySection(0x4000, 0x400f)).toEqual(new Uint8Array(0x10))
    expect(memory.getMemorySection(0x4010, 0x4013)).toEqual(new Uint8Array(0x04))
  })
  ...
  test('should reset the cpu', () => {
    ...
    expect(previousInternalMemory).toEqual(memory.getMemorySection(0x0000, 0x07ff))
  })
})
